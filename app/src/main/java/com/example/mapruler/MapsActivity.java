...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private EditText searchBar, startEditText;// Search bar for manual location search

    private Button findRouteButton, toDestinationButton, fromStartToDestinationButton;
